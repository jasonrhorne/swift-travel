  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (submissionTime > 2000) {
        console.warn(
          `Form submission took ${submissionTime.toFixed(2)}ms - exceeds 2s target`
        );
      } else {
        console.log(
          `Form submission completed in ${submissionTime.toFixed(2)}ms`
        );
      }
      ...
      const submissionTime = endTime - startTime;
      console.error(
        `Form submission failed after ${submissionTime.toFixed(2)}ms:`,
        error
      );
        ...
        <div className="mx-auto max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Our AI agents are now working on your personalized itinerary.
              You'll receive updates as we research, curate, and validate your
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Tell us about your travel preferences and let our AI agents create a
        ...
        <div className="text-center mt-8 text-sm text-gray-500">
          <p>Powered by AI • Personalized for you • Ready in minutes</p>
        </div>
      </div>
    </div>
  );
