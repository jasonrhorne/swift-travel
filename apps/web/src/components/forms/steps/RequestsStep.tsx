    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600">
          Let us know about any special requirements or accessibility needs so
          we can ensure your trip is perfect for you.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mb-4">
          Any specific interests, celebrations, or unique requests? (e.g.,
          "Anniversary dinner", "Vegetarian restaurants", "Photography
          workshops")
        </p>
        ...
        <div className="flex space-x-2 mb-4">
          ...
          <button
            ...
            disabled={
              newSpecialRequest.length < 3 || specialRequests.length >= 5
            }
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mb-4">
          Help us ensure all recommendations are accessible to everyone in your
          group.
        </p>
        ...
        <div className="flex space-x-2 mb-4">
          ...
          <button
            ...
            disabled={
              newAccessibilityNeed.length < 3 || accessibilityNeeds.length >= 10
            }
            className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
          >
            Add
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-green-700">
              You're all set! Our AI agents will use all this information to
              create a personalized itinerary that perfectly matches your
