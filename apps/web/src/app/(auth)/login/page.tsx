...
export default function LoginPage() {
  ...
  // Wait for Zustand persist hydration before redirecting
  useEffect(() => {
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <p className="text-yellow-800 text-sm">
              <strong>⏰ Important:</strong> The magic link will expire in 15
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          ...
          <p className="text-gray-700 text-sm">
            Magic links are more secure than passwords. We'll send you a secure
            link that expires in 15 minutes and can only be used once.
          </p>
        </div>
      </div>
    </div>
